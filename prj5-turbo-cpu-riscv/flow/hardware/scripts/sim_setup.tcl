...
if { [file exists ${bench_dir}/${bench_suite}/sim/${bench_name}.coe] == 1 } {
...
add_files -norecurse -fileset sources_1 ${script_dir}/../${top_dir}/cpu_test_top_golden.v
add_files -norecurse -fileset sources_1 ${script_dir}/../${top_dir}/cpu_wrapper_golden.v
add_files -norecurse -fileset sources_1 ${script_dir}/../../../hardware/golden/

add_files -norecurse -fileset sim_1 ${script_dir}/../${top_dir}/cpu_test_top.v
add_files -norecurse -fileset sim_1 ${script_dir}/../${top_dir}/cpu_test_top_golden.v
add_files -norecurse -fileset sim_1 ${script_dir}/../${top_dir}/cpu_wrapper_golden.v
add_files -norecurse -fileset sim_1 ${script_dir}/../../../hardware/golden/

add_files -norecurse -fileset sim_1 ${script_dir}/../${tb_dir}/fifo.v
add_files -norecurse -fileset sim_1 ${script_dir}/../${tb_dir}/cpu_test.v

if {$bench_suite == "hello" || $bench_suite == "microbench"} {
	set_property verilog_define { {BHV_SIM} {BHV_UART_SIMU} } [get_filesets sources_1]
	set_property verilog_define { {BHV_SIM} {BHV_UART_SIMU} } [get_filesets sim_1]
	add_files -norecurse -fileset sim_1 ${script_dir}/../${tb_dir}/uart_recv_sim.v
} else {
	set_property verilog_define { {BHV_SIM} } [get_filesets sources_1]
	set_property verilog_define { {BHV_SIM} } [get_filesets sim_1]
}

...
#=============================================
  ...
  set weight_bram_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 weight_bram_if ] 
  set_property -dict [ list CONFIG.SINGLE_PORT_BRAM {1} \
					CONFIG.PROTOCOL {AXI4} \
					CONFIG.MEM_DEPTH {16384} ] ${weight_bram_if}

  set data_bram_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 data_bram_if ] 
  set_property -dict [ list CONFIG.SINGLE_PORT_BRAM {1} \
					CONFIG.PROTOCOL {AXI4} \
					CONFIG.MEM_DEPTH {16384} ] ${data_bram_if}
  ...
  set_property -dict [ list CONFIG.use_bram_block {Stand_Alone} \
					...
					CONFIG.Register_PortA_Output_of_Memory_Primitives {false} \
					CONFIG.Load_Init_File {true} \
					CONFIG.Coe_File "${::sim_out_dir}/../../sources/testbench/weight.coe" \
					CONFIG.Fill_Remaining_Memory_Locations {true} ] ${weight_bram}
  ...
  set_property -dict [ list CONFIG.use_bram_block {Stand_Alone} \
					...
					CONFIG.Register_PortA_Output_of_Memory_Primitives {false} \
					CONFIG.Load_Init_File {true} \
					CONFIG.Coe_File "${::sim_out_dir}/../../sources/testbench/data.coe" \
					CONFIG.Fill_Remaining_Memory_Locations {true} ] ${data_bram}
  ...
  # Create instance: AXI GPIO controller to accelerator MMIO 
  ...
  set_property -dict [list CONFIG.NUM_MI {5} CONFIG.NUM_SI {3}] $cpu_ddr_ic
...
#==============================================
  ...
  create_bd_port -dir I -from 0 -to 0 acc_done
  create_bd_port -dir O -from 0 -to 0 gpio_acc_start
...
#==============================================
  ...
  set io_mem [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 io_mem ]
  set_property -dict [ list CONFIG.DATA_WIDTH {64} \
			...
			CONFIG.HAS_PROT {0} \
			CONFIG.HAS_QOS {0} \
			CONFIG.HAS_REGION {0} ] $io_mem

  set_property CONFIG.ASSOCIATED_BUSIF {cpu_inst:cpu_mem:io_mem} [get_bd_ports system_clk]
...
#=============================================
  connect_bd_net -net armv8_ps_fclk_0 [get_bd_ports sys_clk] \
			...
			[get_bd_pins weight_bram_if/s_axi_aclk] \
			[get_bd_pins data_bram_if/s_axi_aclk] \
...
#=============================================
  ...
  connect_bd_net -net zynq_perip_resetn [get_bd_pins zynq_reset_infra/peripheral_aresetn] \
			...
			[get_bd_pins weight_bram_if/s_axi_aresetn] \
			[get_bd_pins data_bram_if/s_axi_aresetn]
...
#==============================================
  ...
  connect_bd_intf_net -intf_net hp0_ddr_inst [get_bd_intf_pins axi_bram_if/S_AXI] \
			[get_bd_intf_pins cpu_ddr_ic/M00_AXI]

  connect_bd_intf_net -intf_net hp0_ddr_data [get_bd_intf_pins data_bram_if/S_AXI] \
			[get_bd_intf_pins cpu_ddr_ic/M01_AXI]

  connect_bd_intf_net -intf_net hp0_ddr_weight [get_bd_intf_pins weight_bram_if/S_AXI] \
			[get_bd_intf_pins cpu_ddr_ic/M02_AXI]
  ...
  connect_bd_intf_net -intf_net io_mem [get_bd_intf_pins cpu_ddr_ic/S02_AXI] \
			[get_bd_intf_pins io_mem]

  connect_bd_intf_net -intf_net axi_uart [get_bd_intf_pins cpu_ddr_ic/M03_AXI] \
			[get_bd_intf_pins axi_uart/S_AXI]

  connect_bd_intf_net -intf_net axi_dnn_mmio [get_bd_intf_pins cpu_ddr_ic/M04_AXI] \
...
#=============================================
  ...
  connect_bd_intf_net [get_bd_intf_pins weight_bram_if/BRAM_PORTA] [get_bd_intf_pins weight_bram/BRAM_PORTA]
  connect_bd_intf_net [get_bd_intf_pins data_bram_if/BRAM_PORTA] [get_bd_intf_pins data_bram/BRAM_PORTA]
...
#=============================================
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x40000000 [get_bd_addr_spaces cpu_inst] [get_bd_addr_segs axi_bram_if/S_AXI/Mem0] CPU_INST
  create_bd_addr_seg -range 0x10000 -offset 0x40000000 [get_bd_addr_spaces cpu_mem] [get_bd_addr_segs axi_bram_if/S_AXI/Mem0] cpu_mem
  create_bd_addr_seg -range 0x10000 -offset 0x40000000 [get_bd_addr_spaces io_mem] [get_bd_addr_segs axi_bram_if/S_AXI/Mem0] IO_mem
  create_bd_addr_seg -range 0x10000 -offset 0x48000000 [get_bd_addr_spaces cpu_inst] [get_bd_addr_segs weight_bram_if/S_AXI/Mem0] CPU_WEIGHT
  create_bd_addr_seg -range 0x10000 -offset 0x48000000 [get_bd_addr_spaces cpu_mem] [get_bd_addr_segs weight_bram_if/S_AXI/Mem0] cpu_weight
  create_bd_addr_seg -range 0x10000 -offset 0x48000000 [get_bd_addr_spaces io_mem] [get_bd_addr_segs weight_bram_if/S_AXI/Mem0] IO_WEIGHT
  create_bd_addr_seg -range 0x10000 -offset 0x48100000 [get_bd_addr_spaces cpu_inst] [get_bd_addr_segs data_bram_if/S_AXI/Mem0] CPU_DATA
  create_bd_addr_seg -range 0x10000 -offset 0x48100000 [get_bd_addr_spaces cpu_mem] [get_bd_addr_segs data_bram_if/S_AXI/Mem0] cpu_data
  create_bd_addr_seg -range 0x10000 -offset 0x48100000 [get_bd_addr_spaces io_mem] [get_bd_addr_segs data_bram_if/S_AXI/Mem0] IO_DATA
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x80040000 [get_bd_addr_spaces cpu_mem] [get_bd_addr_segs axi_gpio_dnn/S_AXI/Reg] CPU_IO

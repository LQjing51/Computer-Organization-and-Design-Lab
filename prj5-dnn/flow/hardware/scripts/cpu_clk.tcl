...
#=============================================
  ...
  # Create instance: 1 x 1 crossbar for GPIO interface of I/O controllers
  set io_ctrl_ic [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 io_ctrl_ic ]
  set_property -dict [list CONFIG.NUM_MI {1} CONFIG.NUM_SI {1}] $io_ctrl_ic

#=============================================
# Clock ports
#=============================================
  # system clock input
  set role_clk [ create_bd_port -dir I -type clk role_clk ]
...
#==============================================
  ...
  set_property CONFIG.ASSOCIATED_RESET {role_resetn} \
...
#=============================================
  ...
  set cpu_io_ctrl [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 cpu_io_ctrl]
  set_property -dict [ list CONFIG.PROTOCOL {AXI4Lite} ] $cpu_io_ctrl

  set_property CONFIG.ASSOCIATED_BUSIF {cpu_perf_cnt:cpu_io_ctrl} [get_bd_ports cpu_clk]
...
#==============================================
  ...
  connect_bd_intf_net -intf_net io_ctrl_ic_s [get_bd_intf_ports cpu_io_ctrl] \
			[get_bd_intf_pins io_ctrl_ic/S00_AXI]

  connect_bd_intf_net -intf_net gpio_ic_m_8 [get_bd_intf_pins io_ctrl_ic/M00_AXI] \
...
#=============================================
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x40040000 [get_bd_addr_spaces cpu_io_ctrl] [get_bd_addr_segs axi_gpio_dnn/S_AXI/Reg] AXI_GPIO_DNN

...
#=============================================
  ...
  # I/O controller DMA port interconnect
  set io_mem_ic [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 io_mem_ic ]
  set_property -dict [list CONFIG.NUM_MI {1} CONFIG.NUM_SI {1}] $io_mem_ic

  set io_mem_downsizer [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dwidth_converter:2.1 io_mem_downsizer ]
  set_property -dict [list CONFIG.SI_DATA_WIDTH.VALUE_SRC {USER} \
      CONFIG.MI_DATA_WIDTH.VALUE_SRC {USER} \
	  CONFIG.SI_DATA_WIDTH {64} \
	  CONFIG.MI_DATA_WIDTH {32} ] $io_mem_downsizer

  # DDR access interconnect
  set cpu_ddr_ic [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 cpu_ddr_ic ]
  set_property -dict [list CONFIG.NUM_MI {1} CONFIG.NUM_SI {3}] $cpu_ddr_ic
...
#==============================================
  ...
  set_property -dict [ list CONFIG.DATA_WIDTH {64} ] $axi_role_to_mem
  ...
  set cpu_io_ctrl [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 cpu_io_ctrl]
  set_property -dict [ list CONFIG.PROTOCOL {AXI4Lite} ] $cpu_io_ctrl
  ...
  set_property CONFIG.ASSOCIATED_BUSIF {cpu_inst:cpu_mem:cpu_perf_cnt:cpu_io_ctrl} [get_bd_ports cpu_clk]
...
#=============================================
  ...
  connect_bd_net -net role_clk [get_bd_ports role_clk] \
			...
			[get_bd_pins io_mem_ic/M00_ACLK] \
			[get_bd_pins io_mem_downsizer/s_axi_aclk] \
...
#=============================================
  ...
  connect_bd_net -net sys_perip_resetn [get_bd_ports sys_port_reset_n] \
			...
			[get_bd_pins io_mem_ic/M00_ARESETN] \
			[get_bd_pins io_mem_downsizer/s_axi_aresetn] \
...
#==============================================
  ...
  # I/O controller memory ports
  connect_bd_intf_net -intf_net io_mem [get_bd_intf_pins io_mem_ic/S00_AXI] \
			[get_bd_intf_ports io_mem]

  connect_bd_intf_net -intf_net io_mem_role [get_bd_intf_pins io_mem_ic/M00_AXI] \
			[get_bd_intf_pins io_mem_downsizer/S_AXI]

  connect_bd_intf_net -intf_net io_mem_down [get_bd_intf_pins io_mem_downsizer/M_AXI] \
			[get_bd_intf_pins cpu_ddr_ic/S02_AXI]

  # CPU DDR port
  connect_bd_intf_net -intf_net cpu_ddr [get_bd_intf_pins cpu_ddr_ic/M00_AXI] \
			[get_bd_intf_pins cpu_ddr_upsizer/S_AXI]

  connect_bd_intf_net -intf_net axi_role_to_mem [get_bd_intf_pins cpu_ddr_upsizer/M_AXI] \
  ...
  connect_bd_intf_net -intf_net cpu_io_ctrl [get_bd_intf_pins cpu_mmio_ic/M02_AXI] \
			[get_bd_intf_pins cpu_io_ctrl]
...
#=============================================
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces io_mem] [get_bd_addr_segs axi_role_to_mem/Reg] IO_DATA
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x40040000 [get_bd_addr_spaces cpu_mem] [get_bd_addr_segs cpu_io_ctrl/Reg] cpu_io_ctrl
